...
<body>
    <header class="header">
     ...
     <div class="content">
            <h3>MAYUR TOURS&TRAVELS</h3>
            <p>We are the creators of Nepal's first fleet of branded buses that guarantee safe & comforable journeys</p>
            <p>We offer you a complete end-to-end travel experience with our professional crew, round the clock command centre and many other features</p><p>We put all our efforts into making every trip and on-time trip!</p>
        </div> 
